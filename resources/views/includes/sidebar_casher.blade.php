        ...
        <div class="card w-100 mb-3">
            <div class="card-header text-center" style="font-family: 'Montserrat', sans-serif; font-size: 22px;">
                ...
                <small class="text-muted" style="font-size: 16px;"> 
                 {{ auth()->user()->role ==4 ? 'Casher' : (auth()->user()->role == 1 ? 'Admin' : 'Casher') }}
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100" id="menu" style="font-family: 'Roboto', sans-serif; font-size: 18px;">
                ...
                <li class="nav-item w-100 mb-3 mt-2">
                    <a href="{{ route('casher.home') }}" class="nav-link px-0 align-middle text-dark d-flex align-items-center ">
                        ...
                        <span class="ms-1 d-none d-sm-inline" style="font-size: 22px;">Dashboard Casher</span>
                    </a>
                </li>
            ...
            <!-- Foods  -->
                <li class="nav-item w-100 mb-3 mt-2">
                    <a href="{{ route('casher.reports') }}" class="nav-link px-0 align-middle text-dark d-flex align-items-center ">
                        ...
                        <span class="ms-1 d-none d-sm-inline" style="font-size: 22px;">Reports</span>
                    </a>
            </li>
        </ul>
        </div>
